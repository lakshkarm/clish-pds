...
# starting to create snapshots here 
    for i in range(1):
        vollist = obj.createVol(11,"manishmg1")
        #obj.assignVol(vollist,"40g-10/3","40g-6/3")
        obj.assignVol(vollist,"40g-6/1","40g-10/2")
        #obj.assignVol(vollist,"40g-4/3")
        #obj.unassignVol(vollist)
        #obj.deleteVol(vollist)
    #obj.deleteSnap(snaplist)
        print i,"th round completed\n"
